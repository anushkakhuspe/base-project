...
3. Update names throughout the package.
	a. Replace `sketch` with the name of your project as it is used in code.
	b. Replace `sketch` Replace with the name of your project as it is used in documentation.
	c. If you're not me, replace `@anushkakhuspe` with your npm username and then `anushkakhuspe` with your GitHub username, and be sure to also update the `author` property in the `package.json`.
